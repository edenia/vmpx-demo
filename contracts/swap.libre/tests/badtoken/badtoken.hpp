...
public:
   ...
   [[eosio::on_notify("swap.libre::transfer")]] void ontransfer(const name &from, const name &to,
                                                                const asset &quantity, const string &memo);
   [[eosio::on_notify("swap.libre::addliquidity")]] void addliquidity(name user, asset to_buy,
                                                                      asset max_asset1, asset max_asset2);
   [[eosio::on_notify("swap.libre::remliquidity")]] void remliquidity(name user, asset to_sell,
